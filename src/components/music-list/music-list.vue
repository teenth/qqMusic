...
<div class="music-list">
  ...
  <div class="bg-layer" ref="bg-layer"></div>
  <scroll :probe-type="this.probeType" :listen-scroll="true" @scroll="scroll" :data="songs" class="list" ref="list">
  ...
  export default{
    ...
    watch: {
      scrollY (newY) {
        ...
        this.$refs['bg-layer'].style[transform] = `translate3d(0,${tanslateY}px, 0)`
        let scale = 1
        let blur = 20
